...
/**
 * Login-only auth frame: a moving canvas and one rounded card. There is
  ...
  return (
    <div className="auth-stage relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="absolute top-4 right-4 z-10">
        <ThemeToggle className="text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[26rem]">
        ...
        <div className="bg-card text-card-foreground relative overflow-hidden rounded-[1.75rem] px-8 py-10 shadow-[0_32px_80px_-24px_color-mix(in_oklch,var(--sidebar)_75%,transparent)] sm:px-10">
          {children}
        </div>
      </div>
    </div>
