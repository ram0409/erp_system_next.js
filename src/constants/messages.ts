...
export const ERROR_MESSAGES = {
  ...
  TWO_FACTOR_CODE_EXPIRED: "This code has expired. Request a new code to continue.",
...
export const SUCCESS_MESSAGES = {
  ...
  TWO_FACTOR_SMS_ENABLED: "SMS one-time passwords are now required at sign-in.",
  TWO_FACTOR_SMS_DISABLED: "SMS one-time passwords have been turned off.",
  ...
  TWO_FACTOR_CODE_SENT: "A verification code has been sent.",
